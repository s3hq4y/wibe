...
def _anthropic_request_to_openai_payload(body: AnthropicMessageRequest) -> Dict[str, Any]:
    ...
    history_mode = getattr(body, "history_mode", None)
    if history_mode is None and hasattr(body, "model_extra") and body.model_extra:
        history_mode = body.model_extra.get("history_mode")
