import { IncontrolConfig } from "core";
 ...
 *
 * @param config - The incontrol configuration object
...
/**
 * Registers all CodeLens providers for the incontrol extension.
 *
...
export function registerAllCodeLensProviders(
  ...
  config: IncontrolConfig | undefined,
) {
