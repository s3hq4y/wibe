        ...
        try {
          ...
          if (e.cause) {
            if (e.cause.name === "ConnectTimeoutError") {
              ...
              message = `The request failed with "${e.cause.name}": ${e.cause.message}. If you're having trouble setting up incontrol, please see the troubleshooting guide for help.`;
            }
          }
        }
      }
