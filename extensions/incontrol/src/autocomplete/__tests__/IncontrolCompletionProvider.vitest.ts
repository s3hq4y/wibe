...
import { IncontrolCompletionProvider } from "../completionProvider";
...
describe("IncontrolCompletionProvider triggering logic", () => {
...
function buildProvider(options: { usingFullFileDiff?: boolean } = {}) {
  ...
  const provider = new IncontrolCompletionProvider(
    configHandler,
    ide,
    webviewProtocol,
    usingFullFileDiff,
