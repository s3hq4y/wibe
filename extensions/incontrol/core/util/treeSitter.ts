...
export const supportedLanguages: { [key: string]: LanguageName } = {
  ...
  // cs: LanguageName.C_SHARP, // grammar not shipped (see scripts/prepackage-standalone.js DROPPED_TREE_SITTER_WASMS)
  c: LanguageName.C,
  h: LanguageName.C,
  ...
  // el: LanguageName.ELISP, // grammar not shipped
  // emacs: LanguageName.ELISP,
  // ex: LanguageName.ELIXIR, // grammar not shipped
  ...
  // ocaml: LanguageName.OCAML, // grammar not shipped
  // ml: LanguageName.OCAML,
  // mli: LanguageName.OCAML,
  // ql: LanguageName.QL, // grammar not shipped
  // res: LanguageName.RESCRIPT, // grammar not shipped
  // resi: LanguageName.RESCRIPT,
  // rb: LanguageName.RUBY, // grammar not shipped
  // erb: LanguageName.RUBY,
  rs: LanguageName.RUST,
  // rdl: LanguageName.SYSTEMRDL, // grammar not shipped
  toml: LanguageName.TOML,
  // sol: LanguageName.SOLIDITY, // grammar not shipped
