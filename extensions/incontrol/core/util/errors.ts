...
export class IncontrolError extends Error {
  reason: IncontrolErrorReason;

  constructor(reason: IncontrolErrorReason, message?: string) {
    super(message);
    this.reason = reason;
    this.name = "IncontrolError";
  }
}

export enum IncontrolErrorReason {
