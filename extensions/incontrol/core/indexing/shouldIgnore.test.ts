...
describe("shouldIgnore", () => {
  ...
  test("should return true if a folder is ignored by .incontrolignore", async () => {
    addToTestDir([
      ["ignored-folder/file.txt", "content"],
      [".incontrolignore", "ignored-folder/"],
    ]);
  ...
  test("should return true if a .incontrolignore override ignores file", async () => {
    addToTestDir([
      ["override-file.txt", "content"],
      [".gitignore", "override-file.txt"],
      [".incontrolignore", "!override-file.txt"],
    ]);
    const result = await shouldIgnore(
  ...
  test("should return true for deeply nested file ignored by ignore files at multiple levels", async () => {
    addToTestDir([
      ...
      ["level1/level2/.incontrolignore", "level3/"],
    ]);
    const result = await shouldIgnore(
