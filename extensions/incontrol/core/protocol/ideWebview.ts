...
export type ToWebviewFromIdeProtocol = ToWebviewFromIdeOrCoreProtocol & {
  ...
  focusIncontrolInput: [undefined, void];
  focusIncontrolInputWithoutClear: [undefined, void];
  focusIncontrolInputWithNewSession: [undefined, void];
  ...
  focusIncontrolSessionId: [{ sessionId: string | undefined }, void];
