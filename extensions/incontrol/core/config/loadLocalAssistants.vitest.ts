...
describe("ASSISTANTS getAllDotIncontrolDefinitionFiles with fileExtType option", () => {
  beforeEach(() => {
    setUpTestDir();
  ...
  it("should return only YAML files when fileExtType is 'yaml'", async () => {
    ...
    const result = await getAllDotIncontrolDefinitionFiles(
      testIde,
      options,
      "assistants",
    );
  ...
  it("should respect includeWorkspace option with fileExtType", async () => {
    ...
    const noWorkspaceResult = await getAllDotIncontrolDefinitionFiles(
      testIde,
      workspaceOffOptions,
      "assistants",
    );
    ...
    const workspaceResult = await getAllDotIncontrolDefinitionFiles(
      testIde,
      workspaceOnOptions,
      "assistants",
    );
  ...
  it("should filter by file extension case sensitively", async () => {
    ...
    const yamlResult = await getAllDotIncontrolDefinitionFiles(
      testIde,
      yamlOptions,
      "assistants",
    );
    ...
    const markdownResult = await getAllDotIncontrolDefinitionFiles(
      testIde,
      markdownOptions,
      "assistants",
    );
...
describe("AGENTS getAllDotIncontrolDefinitionFiles with fileExtType option", () => {
  beforeEach(() => {
    setUpTestDir();
    walkDirCache.invalidate();
