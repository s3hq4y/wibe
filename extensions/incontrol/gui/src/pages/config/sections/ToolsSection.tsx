import { ConfigYaml, parseConfigYaml } from "@incontrol/config-yaml";
import {
  ArrowPathIcon,
  ChevronDownIcon,
  CircleStackIcon,
          ...
          <Listbox>
            ...
            <ListboxOptions className="min-w-fit" anchor="bottom end">
              {server.isProtectedResource && server.status === "connected" && (
                ...
                >
                  <UserCircleIcon className="h-4 w-4 flex-shrink-0" /> {t("Logout")}</ListboxOption>
              )}
