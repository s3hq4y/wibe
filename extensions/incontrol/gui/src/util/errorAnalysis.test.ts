...
describe("errorAnalysis", () => {
  describe("analyzeError", () => {
    ...
    describe("selectedModel handling", () => {
      ...
      it("should use selectedModel info verbatim for unknown providers", () => {
        const selectedModel = {
          title: "Custom Model",
    ...
    describe("provider name passthrough", () => {
      it("should pass through the anthropic provider name", () => {
        const selectedModel = {
      ...
      it("should pass through the groq provider name", () => {
        const selectedModel = {
          title: "Llama 3.1 70B",
      ...
      it("should pass through the ollama provider name", () => {
        const selectedModel = {
          title: "Llama 3.1",
      ...
      it("should keep the provider name casing", () => {
        const selectedModel = {
          title: "GPT-4",
        ...
        expect(result.providerName).toBe("OpenAI"); // shown verbatim
      });
    });
