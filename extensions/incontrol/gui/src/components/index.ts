...
export const defaultBorderRadius = "var(--fluent-radius, 4px)";
...
export const Button = styled.button`
  ...
  transition: background-color var(--fluent-duration, 120ms)
    ...
    box-shadow var(--fluent-duration, 120ms) var(--fluent-ease, ease);

  &:focus-visible {
    outline: 2px solid var(--fluent-stroke-focus, var(--vscode-focusBorder));
    outline-offset: 1px;
  }
