...
<p align="center">
  <a href="./WIBE_VERSION"><img src="https://img.shields.io/badge/%E7%89%88%E6%9C%AC-alpha--1.0.3--base--1.136.1-00A34D?style=flat-square&labelColor=071A10" alt="版本 alpha-1.0.3-base-1.136.1"></a>
...
**版本：** `alpha-1.0.3-base-1.136.1`
Wibe **1.0.3 alpha**，基线为 Code - OSS **1.136.1**。
...
| `WIBE_VERSION` | 展示版本（`alpha-1.0.3-base-1.136.1`） |
