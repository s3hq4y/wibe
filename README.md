...
<p align="center">
  <a href="./WIBE_VERSION"><img src="https://img.shields.io/badge/version-alpha--1.0.1--base--1.136.1-00A34D?style=flat-square&labelColor=071A10" alt="version alpha-1.0.1-base-1.136.1"></a>
...
**Version:** `alpha-1.0.1-base-1.136.1`
...
| `WIBE_VERSION` | Display version (`alpha-1.0.1-base-1.136.1`) |
